...
<center>
    ...
    //$produce = $_POST['produce'];
     // formating the dates
      ...
      //$date2 = $date->format('Y-m-d');
          ...
          $sql ="SELECT id,category,code, description,sizes, brand, type, quantity, price, transaction_date, photo,(quantity*price) as value
            FROM jobuk.products ORDER BY id";
              ...
              <td><a href='#'>".$row["category"]."</a>"."</td>
                  ...
                  <td>".$row["code"]."</td>
                     <td>".$row["quantity"]."</td>
                       ...
                       <td>".$row["price"]."</td>
                  <td>".$row["value"]."</td>
                  <td><img src='actions/documents/".$row['photo']."' ></td>              
                  </tr>");
  ...
  echo "<table style= 'margin-top: 2px;' class='table table-responsive'>";
   echo "<hr>";
  echo "<tr><h3>Analysis are detailed below: <h3></tr>";
  echo "<tr>";
