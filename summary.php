     ...
     // formating the dates
      ...
      $date2 = $date->format('Y-m-d');
          ...
          $sql ="SELECT product, specie, SUM(quantity) as qsold, SUM(unit_price) AS price,            transaction_date, SUM(quantity*unit_price) as value
                FROM joe.sales WHERE transaction_date BETWEEN '$dat1' AND '$dat2'";
            ...
            $sql ="SELECT SUM(amount) AS expense,
              ...
              if ($result-> num_rows >0) {
                ...
                $cash = ($total_sales-$total_expense);

            echo "<tr><td><b>Total sales</b></td><td>".($total_sales)."</td>
                      
                  <td>".$date2."</td>
                  </tr>";
            echo "<tr><td><b>Total expenses</b></td><td>".($total_expense)."</td>
                      
                  <td>".$date2."</td>
                  </tr>";
            echo "<tr><td><b>Total cash in hand</b></td><td>".$cash."</td> 
                  <td>".$date2."</td>
                  </tr>";
