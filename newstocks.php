            ...
            <div class="row">
              ...
              <form class="form-horizontal" action="actions/action_newstock.php" enctype='multipart/form-data' method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="e.g Pants or shoe" id="Brand" name="category" class="wide" min="0" required="required"  >
                    </div>
                  </div> 
                </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Description" id="Brand" name="description" class="wide" min="0" required="required"  >
                    </div>
                  </div> 
                </div>
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                      <!--text input-->
                      <img src="images/images1.jpg" style="max-width: 400px; max-height: 400px;"> 
