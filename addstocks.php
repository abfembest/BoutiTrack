                ...
                <h3 class="card-title">
                  <form action="" method="POST">  
                      ...
                      <span class="form-inline"><label>Products:&nbsp&nbsp&nbsp</label>
                        <select  id="product" name="code" required="required" class="form-inline">
                        <option style=""></option>
                        <?php
                            $query = "SELECT DISTINCT category, code FROM jobuk.products ";
              ...
              <?php
                  if(isset($_POST['Search'])){
                    $product = $_POST['code'];
                     ...
                     $query = "SELECT * FROM jobuk.products  where code='$product'";
                    $result = mysqli_query($connect, $query);
                    while ($row = mysqli_fetch_array($result)) {
                    ?>
              ...
              <form class="form-horizontal" action="actions/action_addstock.php" enctype='multipart/form-data' method="POST">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Email" id="Brand" name="code" class="wide" min="0" required="required" readonly value="<?php echo $row['code']; ?>" >
                    </div>
                  </div> 
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                        ...
                        <?php
                            $query = "SELECT category,code, type FROM jobuk.products WHERE code ='$product'";
                            $result = mysqli_query($connect, $query);    
                            while ($row = mysqli_fetch_array($result)){
