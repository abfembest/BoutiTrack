    ...
    //$produce = $_POST['produce'];
     // formating the dates
      ...
      //$date2 = $date->format('Y-m-d');
          ...
          $sql ="SELECT id, category, description,sizes, brand, type, quantity, price, transaction_date, photo,(quantity*price) as value
            FROM jobuk.products WHERE price =0 ORDER BY id ASC";
