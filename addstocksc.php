        ...
        <div class="row">
          <div class="col-10">
            ...
            <div class="row">
              ...
              <?php
                  if(isset($_POST['Search'])){
                    $product = $_POST['product'];
                     ...
                     $query = "SELECT * FROM jobuk.products  where category='$product'";
                    $result = mysqli_query($connect, $query);
                    while ($row = mysqli_fetch_array($result)) {
                    ?>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="actions/action_addstockc.php" enctype='multipart/form-data' method="POST">
                <div class="card-body">
