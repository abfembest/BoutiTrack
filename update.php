            ...
            <div class="row">
              ...
              <?php
                  $id = $_GET['id'];
                    ...
                    $sql= "SELECT * FROM jobuk.products WHERE id = '$id'";
                  ...
                  <div class="card-header">
                <h3 class="card-title">
                      <a href="update_table.php"><button class="btn btn-primary">Back</button></a>
                Update stocks here</h3>
              ...
              <form class="form-horizontal" action="actions/action_update1.php" enctype='multipart/form-data' method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" id="Brand" name="quantity" class="wide" required="required" value="<?php echo $row['type']; ?>" readonly>
                    </div>
                  </div> 
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" id="Brand" name="quantity" class="wide" required="required" value="<?php echo $row['brand']; ?>" readonly>
                    </div>
                  </div> 
                </div>

                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Sizes</label>
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" id="Brand" name="quantity" class="wide" required="required" value="<?php echo $row['sizes']; ?>" readonly>
                    </div>
                  </div> 
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="number" class="form-control" id="inputEmail3" placeholder="How many units?" id="Brand" name="quantity" class="wide" min="0" required="required" step=".02" value="<?php echo $row['quantity']; ?>" readonly>
                    </div>
                  </div> 
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Code" id="Brand" name="code" class="wide" min="0" required="required">
                    </div>
                  </div> 
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="number" class="form-control" id="inputEmail3" placeholder="Price" id="Brand" name="price" class="wide" min="0" required="required" >
                    </div>
                  </div> 
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="file" class="form-control" id="inputEmail3" id="brand" name="file" class="wide">
                    </div>
                  </div> 
                </div>
